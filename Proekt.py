...
class AboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        layout.addWidget(QLabel("Version DmitryEdition"))
        layout.addWidget(QLabel("Copyright 2018 Shusharin Inc."))
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        stop_btn.setStatusTip("Ostanovit'!")
...
app.setApplicationName("YandexDima")
app.setOrganizationName("YandexDima")
app.setOrganizationDomain("YandexDima.org")
